...
export const products: Product[] = [
  {
    id: "1",
    name: "Вешалка напольная Отрада с полкой для обуви",
    ...
    shortDescription: "Компактная напольная вешалка с полкой для обуви",
  ...
  {
    id: "2",
    name: "Вешалка напольная Отрада с 3 полками",
    ...
    shortDescription: "Напольная вешалка с 3 полками для хранения",
    images: ["/placeholder.svg"],
    colors: ["#1a1a1a", "#f5f5f5", "#d4a574"],
    material: "Металл, ЛДСП",
    dimensions: "80×45×165 см",
  ...
  {
    id: "3",
    name: "Вешалка напольная Отрада с 5 полками",
    ...
    shortDescription: "Вместительная вешалка с 5 полками",
    images: ["/placeholder.svg"],
    colors: ["#1a1a1a", "#f5f5f5", "#d4a574"],
    material: "Металл, ЛДСП",
  ...
  {
    id: "4",
    name: "Зеркало напольное Отрада в металлической раме",
    ...
    shortDescription: "Напольное зеркало в полный рост",
    images: ["/placeholder.svg"],
  ...
  {
    id: "5",
    name: "Стеллаж Отрада узкий с 5 полками",
    ...
    shortDescription: "Компактный узкий стеллаж для любого интерьера",
    images: ["/placeholder.svg"],
    colors: ["#1a1a1a", "#f5f5f5", "#d4a574"],
    material: "Металл, ЛДСП",
