...
export default function Horeca() {
  ...
  const productCategories = [
    {
      title: "Напольные вешалки и стойки",
      description: "Для номеров, коридоров и гардеробных зон: одна и та же модель сразу в нескольких десятках экземпляров.",
    },
    {
      title: "Стеллажи и системы хранения",
      description: "Узкие и стандартные стеллажи для хранения вещей, текстиля, декора и инвентаря.",
    },
    {
      title: "Напольные зеркала в полный рост",
      description: "Для номеров, коридоров, санузлов персонала и примерочных.",
    },
    {
      title: "Аксессуары и колёсики",
      description: "Комплекты колёс для мобильности вешалок и стеллажей. Удобно перемещать мебель при уборке или перестановке.",
    },
  ];
        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-semibold text-foreground leading-tight mb-6">
              ABBOTT HOME для гостиниц, ресторанов и корпоративных клиентов
            </h1>
