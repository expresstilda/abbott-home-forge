          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Группа компаний АББОТТ и ПОЛИВЕР работает с 1991 года в области производства и продажи торгового оборудования. Именно этот опыт позволил объединить в единый производственный цикл все многообразие производственных операций, обеспечило синтез современных процессов и технологий на базе современных станков с ЧПУ, которые и составляют основу нашего производства.
              </p>
            </div>
