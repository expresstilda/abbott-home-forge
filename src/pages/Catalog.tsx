...
export default function Catalog() {
  ...
  const categoryInfo: Record<string, { title: string; description: string }> = {
    all: {
      title: "Каталог товаров АББОТТ ХОУМ",
      description: "Мебель и товары для дома собственного производства. Комбинируйте в системы хранения под ваши потребности.",
    },
    "zerkala": {
      title: "Зеркала напольные и настенные АББОТТ ХОУМ",
      description: "Напольные и настенные зеркала в металлической раме для прихожей, спальни и гардеробной. Безопасное зеркальное полотно AGC с защитной плёнкой.",
    },
    "veshalki-napolnye": {
      title: "Вешалки напольные АББОТТ ХОУМ",
    ...
    "sistema-stenvol": {
      title: "Система Стенвол АББОТТ ХОУМ",
      description: "3 в 1: отделка, мебель, хранение. Комплексные решения для организации пространства.",
    },
    "stoly-i-stoliki": {
      title: "Столы и столики АББОТТ ХОУМ",
      description: "Журнальные и обеденные столы. Прочный металлический каркас и качественные материалы.",
    },
    "etazherki": {
      title: "Этажерки АББОТТ ХОУМ",
      description: "Прочные этажерки в современном дизайне для хранения в любом помещении.",
    },
    "stenovye-paneli": {
      title: "Стеновые декоративные панели АББОТТ ХОУМ",
      description: "Для отделки стен и создания стильных интерьеров.",
    },
  };
      ...
      <div className="container-custom py-8 md:py-12">
        ...
        <div className="mt-16 pt-8 border-t border-border">
          <h2 className="font-serif font-semibold text-xl mb-4">
            Мебель и товары для дома АББОТТ ХОУМ
          </h2>
          <div className="text-sm text-muted-foreground space-y-4 max-w-4xl">
            <p>
              В каталоге АББОТТ ХОУМ представлены напольные вешалки, стеллажи, зеркала и 
              аксессуары собственного производства. Вся продукция изготавливается на 
              современном оборудованием из качественных материалов европейских производителей.
            </p>
            <p>
