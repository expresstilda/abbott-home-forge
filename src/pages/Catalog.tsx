...
export default function Catalog() {
  ...
  const categoryInfo: Record<string, { title: string; description: string }> = {
    ...
    "zerkala-napolnye": {
      title: "Зеркала напольные АББОТТ ХОУМ",
    ...
    "zerkala-nastennye": {
      title: "Зеркала настенные АББОТТ ХОУМ",
      description: "Настенные зеркала в стильных рамах для любого интерьера. Качественное зеркальное полотно европейского производства.",
    },
    "veshalki-napolnye": {
    ...
    "sistemy-hraneniya": {
      title: "Системы хранения АББОТТ ХОУМ",
      description: "Комплексные решения для организации пространства. Модульные системы для прихожей, гардеробной и других помещений.",
    },
    "zhurnalnye-stoliki": {
      title: "Журнальные столики АББОТТ ХОУМ",
      description: "Стильные журнальные столики для гостиной. Прочный металлический каркас и качественные материалы.",
    },
    "etazherki": {
      title: "Этажерки АББОТТ ХОУМ",
      description: "Функциональные этажерки для хранения в любом помещении. Компактные и вместительные решения для организации пространства.",
    },
  };
