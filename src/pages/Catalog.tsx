...
export default function Catalog() {
  ...
  const categoryInfo: Record<string, { title: string; description: string }> = {
    ...
    "zerkala-napolnye": {
      title: "Зеркала напольные ABBOTT HOME",
    ...
    "zerkala-nastennye": {
      title: "Зеркала настенные ABBOTT HOME",
    ...
    "sistemy-hraneniya": {
      title: "Системы хранения ABBOTT HOME",
